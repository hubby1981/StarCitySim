...
public class PlanetWindow extends Window {
    ...
    public PlanetWindow(String name) {
        ...
        int max = RandomRange.getRandom(RandomRange.getRandom(1, 3), RandomRange.getRandom(3, 12));
        ...
        for (int x = 1; x <= max; x++) {
            ...
            if(olds.contains(p.getShaderSurface()))
                p.surfaceA(RandomRange.getRandom(1,5));
