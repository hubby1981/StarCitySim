...
public class DiplomacyWindow extends Window {
    public DiplomacyWindow() {
        ...
        getContents().add(new MenuItemContent(B.get2(R.drawable.relations),  B.get( R.drawable.relationsback), "RELATIONS", "Relations to other races", "12 | 4 | 2", Color.argb(175, 30, 90, 150)));

        getContents().add(new MenuItemContent(B.get2(R.drawable.war),  B.get( R.drawable.warback), "WAR", "War with other races", "1 / 1", Color.argb(175, 30, 90, 150)));
