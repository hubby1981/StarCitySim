...
public class ScienceWindow extends Window {
    public ScienceWindow() {
        ...
        getContents().add(new MenuItemContent(null, B.get(R.drawable.labback), "LABS", "Research new methods", "3 / 4", Color.argb(175, 30, 90, 150)));
        getContents().add(new MenuItemContent(null,  B.get( R.drawable.settleback), "SETTLEMENT", "Research more options", "1 / 1", Color.argb(175, 30, 90, 150)));
        getContents().add(new MenuItemContent(null,  B.get( R.drawable.exploreback), "EXPLORATION", "Research more options", "1 / 1",Color.argb(175, 30, 90, 150),
                new Runnable() {
                    @Override
                    public void run() {
        ...
        getContents().add(new MenuItemContent(null,  B.get( R.drawable.dnaback), "DNA", "Research race abilities", "1 / 1",Color.argb(175, 30, 90, 150),
                new Runnable() {
                    @Override
                    public void run() {
                        Game.changeWindow(new ShipyardWindow());
