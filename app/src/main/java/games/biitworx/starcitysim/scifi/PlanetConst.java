...
public class PlanetConst {
    ...
    public static float MAX_PCM = 0.6f; //Max Core Mass
    public static float MIN_PST = 1.2f; //Min Surface Thickness
    public static float MAX_PST = 3.4f; //Max Surface Thickness
    public static float MIN_PAT = 1.4f; //Min Atmosphere Thickness
    public static float MAX_PAT = 5.4f; //Max Atmosphere Thickness
