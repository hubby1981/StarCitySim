 ...
 */
public class GameViewBackNormal2 extends View {
    ...
    public GameViewBackNormal2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
canvas.drawRect(MenuRects.line.get(),Colors.backPainterContentShader);
        if(view!=null){
            view.scroller=false;
